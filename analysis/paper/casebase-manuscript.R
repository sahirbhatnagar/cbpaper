...
## ----bmtcrr-casebase-weibull, warning = FALSE, eval = eval_cs2----------------
...
## ----stanford-poptime, eval = eval_cs4, fig.cap="\\label{fig:cs4PopTime} Population-time for the Stanford Transplant study. The darker shade of gray corresponds to the exposed person-time."----
...
## ----stanford_cb, eval = eval_cs4, echo = TRUE--------------------------------
...
## ----stanford_exp, eval = eval_cs4, dependson="stanford_cb", echo = TRUE------
...
## ----stanford_fit, eval = eval_cs4, warning = FALSE, echo=TRUE, dependson="stanford_exp"----
# Fit several models
...
## ---- eval = eval_cs4, dependson="stanford_fit", digits = 4-------------------
# Compute AIC
c("Model1" = AIC(fit1),
  "Model2" = AIC(fit2),
  "Model3" = AIC(fit3))
...
## ----stanford-hazard, eval = eval_cs4, echo=TRUE, dependson="stanford_fit", message = FALSE, results="hide", fig.cap="\\label{fig:cs4hazardPlot} Plot of the hazard function for exposed and unexposed individuals."----
...
## ----stanford-risk, eval = eval_cs4, echo = TRUE, dependson="stanford_fit", fig.cap="\\label{fig:cs4CIF} Plot of the cumulative incidence function for exposed and unexposed individuals."----
