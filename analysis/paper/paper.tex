...
\usepackage{amsmath} \usepackage{longtable} \usepackage{graphicx} \usepackage{tabularx} \DeclareUnicodeCharacter{2500}{-}
...
CRAN. Before imputation, there was a total of 1000 individuals and 35
...
description of each variable can be found in Table \ref{tab:support1}
...
This report was generated on 2019-12-11 15:59:22 using the following
...
#> Head:     [bc801c3] 2019-12-11: Merge branch 'Jesse-Islam-master' into review
\end{CodeOutput}
\end{CodeChunk}
