...
R> #times<-seq(from=min(times),to=max(times),length.out = 100)
R> 
...
case-base sampling can also be used in the context of time-dependent
exposure. As an example that already appeared in the literature,
...
R+   newdata = newdata,
R+   time = seq(0, 425, length.out = 100)
R+ )
R> 
R> class(absrisk)
\end{CodeInput}
...
This report was generated on 2020-09-14 12:43:13 using the following
...
#> Head:     [0be28f4] 2020-08-25: switch to plot method for hazard
\end{CodeOutput}
\end{CodeChunk}
