...
summary of the event incidence. Here, we colour the exposed person-time
(i.e.~after transplant) in a darker shade of gray. As we can see, most
events occur early during the follow-up period, and therefore we do not
expect the hazard to be constant.
...
This report was generated on 2020-09-15 17:46:19 using the following
...
#> [58] shape_1.4.4         rlang_0.4.7         pkgconfig_2.0.3    
#> [61] matrixStats_0.56.0  evaluate_0.14       lattice_0.20-41    
#> [64] labeling_0.3        htmlwidgets_1.5.1   cmprsk_2.2-10      
#> [67] tidyselect_1.1.0    deSolve_1.28        plyr_1.8.6         
#> [70] R6_2.4.1            generics_0.0.2      Hmisc_4.4-1        
#> [73] multcomp_1.4-13     DBI_1.1.0           withr_2.2.0        
#> [76] pillar_1.4.6        haven_2.3.1         foreign_0.8-80     
#> [79] mgcv_1.8-33         nnet_7.3-14         mstate_0.2.12      
...
#> Head:     [ddc5b48] 2020-09-14: Merge pull request #29 from sahirbhatnagar/editSahir
\end{CodeOutput}
\end{CodeChunk}
