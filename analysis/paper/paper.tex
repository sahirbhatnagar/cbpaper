...
This report was generated on 2020-07-21 19:46:24 using the following
...
#>  [5] scales_1.1.0              forcats_0.5.0            
#>  [7] stringr_1.4.0             dplyr_0.8.5              
#>  [9] purrr_0.3.4               readr_1.3.1              
#> [11] tidyr_1.0.2               ggplot2_3.3.0            
#> [13] tidyverse_1.3.0           lubridate_1.7.8          
#> [15] visreg_2.6.1              tibble_3.0.1             
#> [17] riskRegression_2020.02.05 prodlim_2019.11.13       
#> [19] flexsurv_1.1.1            survival_3.1-12          
#> [21] pracma_2.2.9              magrittr_1.5             
#> [23] kableExtra_1.1.0          glmnet_3.0-2             
...
#>  [7] fs_1.4.1            rstudioapi_0.11     MatrixModels_0.4-1 
#> [10] fansi_0.4.1         mvtnorm_1.1-0       xml2_1.3.2         
#> [13] codetools_0.2-16    knitr_1.29          Formula_1.2-3      
#> [16] jsonlite_1.6.1      cluster_2.1.0       dbplyr_1.4.3       
#> [19] png_0.1-7           compiler_4.0.0      httr_1.4.1         
#> [22] backports_1.1.8     assertthat_0.2.1    cli_2.0.2          
#> [25] acepack_1.4.1       htmltools_0.5.0     quantreg_5.55      
#> [28] tools_4.0.0         gtable_0.3.0        Rcpp_1.0.4.6       
#> [31] cellranger_1.1.0    vctrs_0.3.1         nlme_3.1-147       
#> [34] iterators_1.0.12    xfun_0.15           rvest_0.3.5        
#> [37] lifecycle_0.2.0     polspline_1.1.17    muhaz_1.2.6.1      
#> [40] MASS_7.3-51.5       zoo_1.8-7           hms_0.5.3          
#> [43] sandwich_2.5-1      SparseM_1.78        RColorBrewer_1.1-2 
#> [46] rticles_0.14        yaml_2.2.1          gridExtra_2.3      
#> [49] rms_5.1-4           rpart_4.1-15        latticeExtra_0.6-29
#> [52] stringi_1.4.6       foreach_1.5.0       checkmate_2.0.0    
#> [55] lava_1.6.7          shape_1.4.4         rlang_0.4.6        
#> [58] pkgconfig_2.0.3     evaluate_0.14       lattice_0.20-41    
#> [61] htmlwidgets_1.5.1   cmprsk_2.2-9        tidyselect_1.1.0   
#> [64] deSolve_1.28        R6_2.4.1            generics_0.0.2     
#> [67] Hmisc_4.4-0         multcomp_1.4-13     DBI_1.1.0          
#> [70] withr_2.2.0         pillar_1.4.4        haven_2.2.0        
#> [73] foreign_0.8-78      mgcv_1.8-31         nnet_7.3-13        
#> [76] mstate_0.2.12       modelr_0.1.6        crayon_1.3.4       
#> [79] rmarkdown_2.1       jpeg_0.1-8.1        grid_4.0.0         
#> [82] readxl_1.3.1        reprex_0.3.0        digest_0.6.25      
#> [85] webshot_0.5.2       numDeriv_2016.8-1.1 stats4_4.0.0       
#> [88] munsell_0.5.0       viridisLite_0.3.0   quadprog_1.5-8
\end{CodeOutput}
\end{CodeChunk}
...
#> Head:     [2d08bac] 2020-07-20: Merge pull request #22 from sahirbhatnagar/write-popTime
\end{CodeOutput}
\end{CodeChunk}
