...
the \pkg{casebase} package using the \code{popTime} function. This is
done in two steps:

\begin{enumerate}
\item Pass your dataset to the casebase::popTime function and specify the column names corresponding to
...
plots, and we can generate the plot by using the corresponding
\code{plot} method:
