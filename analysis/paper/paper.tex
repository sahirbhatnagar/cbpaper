...
\midrule
Sex & 0.72 & (0.42, 1.26) & 0.68 & (0.39, 1.19)\\
Disease & 0.54 & (0.3, 0.97) & 0.52 & (0.29, 0.93)\\
Phase (CR2 vs. CR1) & 1.21 & (0.48, 3.02) & 1.21 & (0.48, 3.02)\\
Phase (CR3 vs. CR1) & 1.63 & (0.41, 6.44) & 1.67 & (0.43, 6.5)\\
Phase (Relapse vs. CR1) & 4.43 & (2.06, 9.55) & 4.55 & (2.09, 9.9)\\
\addlinespace
Source & 1.51 & (0.49, 4.69) & 1.46 & (0.47, 4.54)\\
...
This report was generated on 2020-08-20 19:21:21 using the following
...
#>  [7] tidyr_1.1.0               ggplot2_3.3.2.9000       
#>  [9] tidyverse_1.3.0           lubridate_1.7.4          
#> [11] visreg_2.7.0              tibble_3.0.1             
#> [13] riskRegression_2020.02.05 prodlim_2019.11.13       
#> [15] flexsurv_1.1.1            survival_3.1-8           
...
#> [10] mvtnorm_1.0-12      xml2_1.3.0          codetools_0.2-16   
#> [13] knitr_1.29          Formula_1.2-3       jsonlite_1.7.0     
#> [16] broom_0.7.0         cluster_2.1.0       dbplyr_1.4.2       
#> [19] png_0.1-7           compiler_3.6.2      httr_1.4.1         
#> [22] backports_1.1.8     assertthat_0.2.1    cli_2.0.2          
#> [25] acepack_1.4.1       htmltools_0.5.0     quantreg_5.54      
#> [28] tools_3.6.2         gtable_0.3.0        glue_1.4.1         
...
#> [61] lattice_0.20-38     htmlwidgets_1.5.1   cmprsk_2.2-9       
#> [64] tidyselect_1.1.0    deSolve_1.27.1      R6_2.4.1           
#> [67] generics_0.0.2      Hmisc_4.3-1         multcomp_1.4-12    
#> [70] DBI_1.1.0           withr_2.2.0         pillar_1.4.4       
#> [73] haven_2.3.1         foreign_0.8-74      mgcv_1.8-31        
#> [76] nnet_7.3-12         mstate_0.2.12       modelr_0.1.5       
#> [79] crayon_1.3.4        rmarkdown_2.3       timereg_1.9.4      
#> [82] jpeg_0.1-8.1        grid_3.6.2          readxl_1.3.1       
#> [85] reprex_0.3.0        digest_0.6.25       webshot_0.5.2      
#> [88] numDeriv_2016.8-1.1 stats4_3.6.2        munsell_0.5.0      
...
#> Head:     [f618e21] 2020-08-18: time dependent hazard ratio for ERSPC
\end{CodeOutput}
\end{CodeChunk}
