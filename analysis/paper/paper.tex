...
This report was generated on 2020-07-19 18:02:45 using the following
...
#>  [7] dplyr_0.8.5               purrr_0.3.4              
#>  [9] readr_1.3.1               tidyr_1.1.0              
#> [11] ggplot2_3.3.2.9000        tidyverse_1.3.0          
#> [13] lubridate_1.7.4           visreg_2.7.0             
#> [15] tibble_3.0.1              riskRegression_2020.02.05
#> [17] prodlim_2019.11.13        flexsurv_1.1.1           
#> [19] survival_3.1-8            pracma_2.2.9             
#> [21] magrittr_1.5              kableExtra_1.1.0         
#> [23] glmnet_4.0-2              Matrix_1.2-18            
#> [25] data.table_1.12.8         cowplot_1.0.0            
#> [27] colorspace_1.4-1          casebase_0.9.0           
#> 
...
#> [43] scales_1.1.1        hms_0.5.3           sandwich_2.5-1     
#> [46] SparseM_1.78        RColorBrewer_1.1-2  rticles_0.13       
#> [49] yaml_2.2.1          gridExtra_2.3       rms_5.1-4          
#> [52] rpart_4.1-15        latticeExtra_0.6-29 stringi_1.4.6      
#> [55] foreach_1.5.0       checkmate_2.0.0     lava_1.6.6         
#> [58] shape_1.4.4         rlang_0.4.6         pkgconfig_2.0.3    
#> [61] evaluate_0.14       lattice_0.20-38     labeling_0.3       
#> [64] htmlwidgets_1.5.1   cmprsk_2.2-9        tidyselect_1.1.0   
#> [67] deSolve_1.27.1      plyr_1.8.6          R6_2.4.1           
...
#> [85] grid_3.6.2          readxl_1.3.1        reprex_0.3.0       
#> [88] digest_0.6.25       webshot_0.5.2       numDeriv_2016.8-1.1
#> [91] stats4_3.6.2        munsell_0.5.0       viridisLite_0.3.0  
#> [94] quadprog_1.5-8
\end{CodeOutput}
\end{CodeChunk}
...
#> Head:     [dad6070] 2020-07-18: cleaned cs1
\end{CodeOutput}
\end{CodeChunk}
