...
\citep{casebase-package} implemented in \proglang{R} \citep{r-core}, for
...
{\centering \includegraphics[width=\textwidth,keepaspectratio=true]{plot-stratified-erspc-data-1}
...
{\centering \includegraphics[width=\textwidth,keepaspectratio=true]{compPop-1}
...
{\centering \includegraphics[width=\textwidth,keepaspectratio=true]{bmtcrr-risk-1}
...
{\centering \includegraphics[width=\textwidth,keepaspectratio=true]{coefplots-1}
...
{\centering \includegraphics[width=\textwidth,keepaspectratio=true]{riskregressionBrier-1}
...
{\centering \includegraphics[width=\textwidth,keepaspectratio=true]{stanford-poptime-1}
...
fitting the hazard function. For this reason, we use the
...
Next, we compute the number of days from acceptance into the program to
transplant, and we use this variable to determine whether each
population-moment is exposed or not.
...
{\centering \includegraphics[width=\textwidth,keepaspectratio=true]{stanford-hazard-1}
...
{\centering \includegraphics[width=\textwidth,keepaspectratio=true]{stanford-risk-1}
...
\pkg{casebase} package is freely available from the Comprehensive
