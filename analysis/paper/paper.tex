...
\Plainauthor{Sahir Rai Bhatnagar*, Maxime Turgeon*, Jesse Islam, James
A. Hanley, Olli Saarela}
\Plaintitle{casebase: An Alternative Framework For Survival Analysis and
Comparison of Event Rates}
\Shorttitle{\pkg{casebase}: An Alternative Framework For Survival
Analysis}
...
the likelihood expression or the estimating function. But to estimate
risks, the baseline hazard needs to be estimated separately using a
non-parametric method. This apparoch leads to step-wise estimates of the
cumulative incidence that are difficult to interpret. Using case-base
sampling, Hanley \& Miettinen explained how the parametric hazard
functions can be estimated using logistic regression. Their approach
naturally leads to estimates of the cumulative incidence that are
smooth-in-time.\\
In this paper, we present the casebase R package, which implements the
ideas of Hanley \& Miettinen through a simple and flexible interface. We
...
\Keywords{survival analysis, absolute risk, \proglang{R}, data
visualization}
...
of the survival function that can be hard to interpret.
...
approach provides users familiar with generalized linear models with a
...
\caption{\label{fig:cs3lolliPlot} Lollipop plot showing the coefficient estimates between three models. Only covariates common among all three models were retained. Shrinkage occurs due to penalization.}\label{fig:coefplots}
\end{figure}
\end{CodeChunk}
...
\caption{\label{fig:cs3FinalBrier} Comparison of Cox regression, penalized Cox regression, penalized case-base estimation, and Kaplan-Meier. (A)  Probabilities of death as it changes over follow-up time. (B) Brier scores as they change over time, where a lower score corresponds to better performace.}\label{fig:riskregressionBrier}
\end{figure}
\end{CodeChunk}
...
This report was generated on 2020-09-16 10:30:17 using the following
...
#> [23] kableExtra_1.2.1          glmnet_4.0-2             
#> [25] Matrix_1.2-18             data.table_1.13.0        
#> [27] cowplot_1.1.0             colorspace_1.4-1         
#> [29] casebase_0.9.0.9000      
#> 
#> loaded via a namespace (and not attached):
#>  [1] TH.data_1.0-10      VGAM_1.1-3          ellipsis_0.3.1     
#>  [4] ggstance_0.3.4      htmlTable_2.0.1     base64enc_0.1-3    
...
#> [16] Formula_1.2-3       jsonlite_1.7.1      cluster_2.1.0      
#> [19] dbplyr_1.4.4        png_0.1-7           compiler_4.0.2     
#> [22] httr_1.4.2          backports_1.1.9     assertthat_0.2.1   
#> [25] cli_2.0.2           htmltools_0.5.0     quantreg_5.67      
#> [28] tools_4.0.2         gtable_0.3.0        Rcpp_1.0.5         
...
#> [64] htmlwidgets_1.5.1   cmprsk_2.2-10       tidyselect_1.1.0   
#> [67] deSolve_1.28        plyr_1.8.6          R6_2.4.1           
#> [70] generics_0.0.2      Hmisc_4.4-1         multcomp_1.4-13    
#> [73] DBI_1.1.0           withr_2.2.0         pillar_1.4.6       
#> [76] haven_2.3.1         foreign_0.8-80      mgcv_1.8-33        
#> [79] nnet_7.3-14         mstate_0.2.12       modelr_0.1.8       
#> [82] crayon_1.3.4        rmarkdown_2.3       jpeg_0.1-8.1       
#> [85] grid_4.0.2          readxl_1.3.1        blob_1.2.1         
#> [88] reprex_0.3.0        digest_0.6.25       webshot_0.5.2      
#> [91] numDeriv_2016.8-1.1 stats4_4.0.2        munsell_0.5.0      
#> [94] viridisLite_0.3.0   quadprog_1.5-8
\end{CodeOutput}
\end{CodeChunk}
...
\begin{CodeOutput}
#> Local:    master /Users/maxturgeon/Documents/git_repos/cbpaper
#> Remote:   master @ origin (git@github.com:sahirbhatnagar/cbpaper.git)
#> Head:     [73c0393] 2020-09-15: update CS3
\end{CodeOutput}
\end{CodeChunk}
