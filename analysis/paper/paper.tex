...
\begin{CodeInput}
R> 
R> cbFull <- casebase::fitSmoothHazard.fit(x, y, family = "glmnet", time = "d.time", event = "death", formula_time = ~ log(d.time), alpha = 1, ratio = ratio, standardize = TRUE)
\end{CodeInput}
\end{CodeChunk}
...
R> abCbFull <- casebase::absoluteRisk(cbFull, time = seq(1, max(abKMcompare[, 1]), 25), newdata = newData, s = "lambda.1se", method = c("numerical"))
\end{CodeInput}
\end{CodeChunk}
...
R> lolliplotDots$conf.low <- lolliplotDots$estimate
R> lolliplotDots$conf.high <- lolliplotDots$estimate
...
This report was generated on 2020-03-06 08:01:48 using the following
...
#>  [1] broom_0.5.5         dotwhisker_0.5.0    pracma_2.2.9       
#>  [4] kableExtra_1.1.0    data.table_1.12.8   glmnet_3.0-2       
#>  [7] Matrix_1.2-17       casebase_0.2.1.9001 survival_3.1-8     
...
#> Head:     [6682dfb] 2020-03-06: NOT COMPLETE
\end{CodeOutput}
\end{CodeChunk}
