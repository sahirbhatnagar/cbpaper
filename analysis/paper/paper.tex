...
problems or future features we would like to add to casebase. In
particular, we excluded packages that were focused on a different set of
problems, such as frailty and multi-state models, as casebase is
currently focused on absolute-risk, competing events and single event
analysis.
...
This report was generated on 2019-12-11 15:31:05 using the following
...
#> Head:     [32c45a7] 2019-12-08: fix table captions
\end{CodeOutput}
\end{CodeChunk}
