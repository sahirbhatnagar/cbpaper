...
to the function \code{fitSmoothHazard}. In order to use this interface,
we first create a matrix \code{y} containing the time and event
variables, and a matrix \code{x} containing all remaining covariates we
would like to include in the model space. We used lasso penalization by
setting \code{alpha = 1}. Moreover, we use the argument
...
This report was generated on 2020-08-31 10:05:10 using the following
...
#> [28] quantreg_5.55       tools_4.0.2         gtable_0.3.0       
#> [31] Rcpp_1.0.5          cellranger_1.1.0    vctrs_0.3.2        
#> [34] nlme_3.1-148        iterators_1.0.12    xfun_0.15          
#> [37] rvest_0.3.6         lifecycle_0.2.0     polspline_1.1.17   
...
#> [73] withr_2.2.0         pillar_1.4.6        haven_2.3.1        
#> [76] foreign_0.8-80      mgcv_1.8-31         nnet_7.3-14        
#> [79] mstate_0.2.12       modelr_0.1.8        crayon_1.3.4       
#> [82] rmarkdown_2.3       jpeg_0.1-8.1        grid_4.0.2         
