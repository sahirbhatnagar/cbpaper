...
\begin{longtable}{lp{1in}p{2in}p{1.1in}}
%  \begin{tabular}{lp{1in}p{2in}p{1.1in}}
\hline
    Package &    documentation  & Type & Function Call\\
    % & {\footnotesize{(location in \code{\color{red}{red}})}} & & \\
\hline
    \href{https://cran.r-project.org/package=flexsurv}{flexsurv}  & \href{https://cran.r-project.org/web/packages/flexsurv/vignettes/flexsurv.pdf}{Vignette}, \href{https://www.jstatsoft.org/article/view/v070i08}{Jackson, C. JSS 2016}  & Fully-parametric. Also includes the spline model of Royston and Parmar (2002), in which both baseline survival and covariate effects can be arbitrarily flexible parametric functions of time. &   \texttt{flexsurvreg(Surv(recyrs, censrec) ~ group, data = bc, dist = "gengamma")}   \texttt{flexsurvspline(Surv(recyrs, censrec) ~ group, data = bc, k = 1, scale = "odds")}  \\
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% \\
    \href{https://cran.r-project.org/package=AdapEnetClass}{AdapEnetClass}  & \href{https://link.springer.com/article/10.1007/s11222-015-9555-8}{Khan et al. Statistics and Computing 2016}  & Variable selection in AFT models using elastic net. No absolute risk estimates.    &   \texttt{cv.AWEnet(x, y, delta, weight=wt, lambda2=0.001, maxit=10, plot.it = T, AEnet=T)}  \\
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% \\
    \href{https://cran.r-project.org/package=eha}{eha}  & \href{https://cran.r-project.org/web/packages/eha/vignettes/parametric.pdf}{Vignette}  & AFT model. Automatic produces plot of estimated smooth hazard function.    &   \texttt{phreg(Surv(enter + 40, exit + 40, event) ~ I(birthdate - 1810) + strata(ses), data = mort, dist = "gompertz")}  \\
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% \\
    \href{https://cran.r-project.org/package=smoothSurv}{smoothSurv}  & \href{https://cran.r-project.org/web/packages/smoothSurv/smoothSurv.pdf}{R manual}  & An AFT model with an error distribution assumed to be a mixture of G-splines    &   \texttt{smoothSurvReg(surv ~ x1 * x2, logscale = ~1, info = FALSE, lambda = exp(2:(-1)))}  \\
\hline
%  \end{tabular}
...
This report was generated on 2019-07-29 10:55:18 using the following
...
\begin{CodeOutput}
#> Local:    litreview-sahir /home/sahir/git_repositories/cbpaper
#> Remote:   litreview-sahir @ origin (https://github.com/sahirbhatnagar/cbpaper)
#> Head:     [c0cb26d] 2019-07-23: Merge pull request #6 from sahirbhatnagar/fixdocker
\end{CodeOutput}
\end{CodeChunk}
