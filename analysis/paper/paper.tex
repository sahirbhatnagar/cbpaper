...
This report was generated on 2020-01-21 11:25:53 using the following
...
#>  casebase    * 0.2.1.9001 2020-01-10 [1]
...
#>  CRAN (R 3.6.1)                          
#>  CRAN (R 3.6.1)                          
#>  Github (sahirbhatnagar/casebase@ae42a9f)
#>  CRAN (R 3.6.1)                          
#>  CRAN (R 3.6.2)                          
#>  CRAN (R 3.5.2)                          
#>  CRAN (R 3.6.1)                          
...
#> Head:     [db3b3b1] 2019-12-12: review of cs 3 with new version of package
\end{CodeOutput}
\end{CodeChunk}
