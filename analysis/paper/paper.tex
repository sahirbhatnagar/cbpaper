...
\midrule
Sex & 0.77 & (0.45, 1.35) & 0.68 & (0.39, 1.19)\\
Disease & 0.58 & (0.32, 1.04) & 0.52 & (0.29, 0.93)\\
Phase (CR2 vs. CR1) & 1.11 & (0.45, 2.76) & 1.21 & (0.48, 3.02)\\
Phase (CR3 vs. CR1) & 1.58 & (0.41, 6.04) & 1.67 & (0.43, 6.5)\\
Phase (Relapse vs. CR1) & 3.89 & (1.81, 8.35) & 4.55 & (2.09, 9.9)\\
\addlinespace
Source & 1.48 & (0.49, 4.46) & 1.46 & (0.47, 4.54)\\
...
seriously ill within a hospital. Imputation was conducted using
predictive mean matching and using the \pkg{mice} package in
\proglang{R}. Before imputation, there was a total of 1000 individuals
and 35 variables. After imputation, we have 474 observations where
67.5\% of individuals in the study experience the event of interest.
\textcolor{red}{How come we lose individuals during imputation?} The
SUPPORT dataset will be used to demonstrate regularization within
casebase, while comparing their absolute risk predictions for a new
individual. A description of each variable can be found in Table
\ref{tab:support1} and a breakdown of each categorical variable in Table
\ref{tab:support2}. The data was downloaded from the main author's
website, and it is also available as part of the \pkg{casebase} package.
...
informative of death. The glmnet package on CRAN was used to introduce
elastic net, lasso and ridge regressions to casebase. To visualize the
incidence density, we can refer to the post-imputation population-time
plot in Figure \ref{fig:ptPostI}.
...
\begin{CodeInput}
R> popTime_post <- popTime(as.data.frame(completeData),
R>                         time = "d.time", event = "death")
R> plot(popTime_post)
\end{CodeInput}
\end{CodeChunk}
...
This report was generated on 2019-12-12 13:11:14 using the following
...
#> Head:     [c4f42a9] 2019-12-11: Merge branch 'review-glmnet' into review
\end{CodeOutput}
\end{CodeChunk}
