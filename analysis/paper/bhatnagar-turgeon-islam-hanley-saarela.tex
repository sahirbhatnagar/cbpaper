...
could compute Akaike's Information Criterion (AIC) for each model and
compare them.
...
covariate profiles and times for the predicted hazards.
...
\includegraphics[width=\textwidth,keepaspectratio=true]{./cs1hazard-1} \end{Schunk}
