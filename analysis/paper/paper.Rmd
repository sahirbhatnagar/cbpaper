...
```{r support-poptime, echo = TRUE, eval = eval_cs3, fig.cap="\\label{fig:support-poptime} Population-time plot for the SUPPORT data."}
...
```{r baselinePlotsPrep, eval=eval_cs3}
...
```{r baselines, echo=FALSE,eval=eval_cs3,fig.cap="\\label{fig:baselines} AbsoluteRisk curves from hazard models. Pink: All covariates without SPS nor APS. Green: APS only model. Blue: SPS only model. Purple: unadjusted curve. All three models underestimate the risk in comparison to the unadjusted curve."}
...
lolliplotDots$conf.low<-NA
lolliplotDots$conf.high<-NA
