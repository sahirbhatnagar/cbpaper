...
<!-- $$ h(t;X) = \exp[g(t;X)] $$ -->
<!-- where $t$ denotes time and $X$, the individual's covariate profile.  -->

Let $g(t; X)$ be the linear predictor such that $\log(h(t;X)) = g(t; X)$. Different functions of $t$ lead to different parametric hazard models. The simplest of these models is the one-parameter exponential distribution which is obtained by taking the hazard function to be constant over the range of $t$:
