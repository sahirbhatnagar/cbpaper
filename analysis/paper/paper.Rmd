...
plot(pt_object, 
     ...
     base.params = list(size = 0.8)) + theme_bw(base_size = 10) + theme(legend.position = "bottom") + 
...
cox_ci <- ggplot(baseCoxComparisonData, aes(Time)) +
  ...
  scale_color_manual(values = q4, breaks = c("APS", "Full", "SPS", "K-M")) + theme_bw(base_size = 10) + theme(legend.position = "bottom")
```
...
cox_brier <- ggplot(data = brierPlotter, mapping = aes(x = times, y = brierScore, col = model)) +
  ...
  scale_color_manual(values = q4[1:3]) + theme_bw(base_size = 10)
...
plot(stanford_popTime,
     ribbon.params = list(fill = "grey50")) + theme_bw(base_size = 10) + theme(legend.position = "bottom") 
```
...
plot(absrisk,
     id.names = c("NoTrans","Trans")) + theme_bw(base_size = 10) + theme(legend.position = "bottom")
