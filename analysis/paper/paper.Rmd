...
#                                            data = ERSPC, 
#                                            ratio = 100)
# smooth_risk_weibull <- casebase::absoluteRisk(object = casebase_weibull, 
#                                            time = seq(0,15,0.1), 
#                                            newdata = new_data)
...
#                                               newdata = new_data)
# 
# casebase_interaction <- casebase::fitSmoothHazard(DeadOfPrCa ~ Follow.Up.Time*ScrArm, 
#                                                   data = ERSPC, 
#                                                   ratio = 100)
# smooth_risk_interaction <- casebase::absoluteRisk(object = casebase_interaction, 
#                                                   time = seq(0,15,0.1), 
#                                                   newdata = new_data)

# par(mfrow = c(2, 2))
# casebase::hazardPlot(casebase_interaction, newdata = new_data[2,], ci = FALSE)
# casebase::hazardPlot(casebase_interaction, newdata = new_data[1,], ci = FALSE, add = TRUE, lty = 2)
# 
# casebase::hazardPlot(casebase_splines, newdata = new_data[2,], ci = FALSE)
# casebase::hazardPlot(casebase_splines, newdata = new_data[1,], ci = FALSE, add = TRUE, lty = 2)
# 
# casebase::hazardPlot(casebase_time, newdata = new_data[2,], ci = FALSE)
# casebase::hazardPlot(casebase_time, newdata = new_data[1,], add = TRUE, lty = 2)
# 
# casebase::hazardPlot(casebase_exponential, newdata = new_data[2,], ci = FALSE)
# casebase::hazardPlot(casebase_exponential, newdata = new_data[1,], add = TRUE, lty = 2)
