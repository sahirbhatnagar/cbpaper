...
As we can see, the best fit is the third model. By visualizing the hazard functions for both exposed and unexposed individuals, we can more clearly see how the hazards are no longer proportional.

```{r stanford-hazard, eval = eval_cs4, echo=TRUE, dependson="stanford_fit"}
# Compute hazards---
...
hazard_data$hazard <- exp(predict(fit3,
  newdata = hazard_data,
  type = "link"
))
...
```{r stanford-risk, eval = eval_cs4, dependson="stanford_fit"}
